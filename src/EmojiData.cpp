// Emoji tables adapted from Globed (MIT, https://github.com/GlobedGD/globed2),
// generated from src/ui/Emojis.cpp. Emoji art is Twemoji (CC-BY 4.0).

#include "Emojis.hpp"

using namespace geode::prelude;

namespace gc::emoji::detail {
...
const std::vector<std::pair<std::u32string_view, const char*>>& registryEntries() {
    static const std::vector<std::pair<std::u32string_view, const char*>> entries = {
...
// shortcode -> UTF-8, in the original order so the first alias of each emoji is the "main" one
const std::vector<std::pair<std::string_view, std::u8string_view>>& shortcodeEntries() {
    static const std::vector<std::pair<std::string_view, std::u8string_view>> entries = {
